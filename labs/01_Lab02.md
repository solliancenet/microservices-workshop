...
30. Now you can create an ingress resource for the content applications.
...
31. Create the ingress using kubectl.

    ```bash
    kubectl create --save-config=true -f content.ingress.yml
    ```

32. Refresh the ingress endpoint in your browser. You should be able to visit the speakers and sessions pages and see all the content.

33. Visit the api directly, by navigating to `/content-api/sessions` at the ingress endpoint.
